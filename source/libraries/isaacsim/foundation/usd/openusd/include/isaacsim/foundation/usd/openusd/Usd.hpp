...
#include <isaacsim/foundation/usd/openusd/Export.h>
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API int64_t createStage();
 ...
 * @return Stage identifier registered in the stage cache, or -1 on failure.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API int64_t openStage(const std::string& usdPath);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool saveStage(int64_t stageId, const std::string& usdPath);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool closeStage(int64_t stageId);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::string exportStageToString(int64_t stageId);
 ...
 * @return Stage identifier registered in the stage cache, or -1 on failure.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API int64_t importStageFromString(const std::string& usdString);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool isStageValid(int64_t stageId);

/**
 * @brief Returns an opaque pointer to the underlying UsdStage object.
 * @param[in] stageId Stage identifier to get the pointer for.
 * @return Opaque pointer to the UsdStage object, or nullptr if the stage is not valid.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void* getStagePtr(int64_t stageId);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void definePrim(int64_t stageId,
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::tuple<bool, std::string> movePrim(int64_t stageId,
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool removePrim(int64_t stageId, const std::string& path);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void traversePrim(int64_t stageId,
                                                      const std::string& path,
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::tuple<float, float> getStageUnits(int64_t stageId);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void setStageUnits(int64_t stageId,
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::string getStageUpAxis(int64_t stageId);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void setStageUpAxis(int64_t stageId, const std::string& upAxis);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::tuple<float, float, float> getStageTimeCode(int64_t stageId);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void setStageTimeCode(int64_t stageId,
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void addReferenceToStage(int64_t stageId,
                                                             const std::string& path,
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::string generateStageRepresentation(int64_t stageId,
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::vector<std::string> findMatchingPrimPaths(int64_t stageId,
                                                                                   const std::string& path,
                                                                                   bool traverse = false);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool isValidPathString(const std::string& path);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool isPrimValid(int64_t stageId, const std::string& path);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::string getName(int64_t stageId, const std::string& path);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::string getTypeName(int64_t stageId, const std::string& path);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::string getParent(int64_t stageId, const std::string& path);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::vector<std::string> getChildren(int64_t stageId, const std::string& path);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool isA(int64_t stageId, const std::string& path, const std::string& schemaType);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool hasApi(int64_t stageId,
                                                const std::string& path,
 ...
 * @throws std::invalid_argument if @p schemaType is unknown or is not an applied API schema.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool applyApi(int64_t stageId,
                                                  const std::string& path,
                                                  const std::string& schemaType,
                                                  const std::optional<std::string>& instanceName = std::nullopt);
 ...
 * @throws std::invalid_argument if @p schemaType is unknown or is not an applied API schema.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool removeApi(int64_t stageId,
                                                   const std::string& path,
                                                   const std::string& schemaType,
                                                   const std::optional<std::string>& instanceName = std::nullopt);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::vector<std::string> getAppliedSchemas(int64_t stageId, const std::string& path);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::unordered_map<std::string, std::vector<std::string>> getVariants(
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void setVariants(
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool createPrimAttribute(int64_t stageId,
                                                             const std::string& path,
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API bool removePrimAttribute(int64_t stageId,
                                                             const std::string& path,
                                                             const std::string& attributeName);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::string getPrimAttributeTypeName(int64_t stageId,
                                                                         const std::string& path,
                                                                         const std::string& attributeName);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::vector<std::string> getPrimAttributeNames(int64_t stageId,
                                                                                   const std::string& path);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API AttributeValues getPrimAttributeValues(int64_t stageId,
 ...
 * @throws isaacsim::common::exceptions::AttributeNameError If any prim lacks @p attributeName.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::vector<bool> setPrimAttributeValues(int64_t stageId,
                                                                             const std::vector<std::string>& paths,
                                                                             const std::string& attributeName,
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void resetXformOpProperties(int64_t stageId, const std::string& path);
 ...
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API array::Array getXformLocalScales(int64_t stageId,
                                                                     const std::vector<std::string>& paths);
 ...
 * length.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void setXformLocalScales(int64_t stageId,
                                                             const std::vector<std::string>& paths,
 ...
 * @throws std::invalid_argument If any path does not refer to a valid or Xformable prim.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::tuple<array::Array, array::Array> getXformLocalPoses(
 ...
 * length.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void setXformLocalPoses(int64_t stageId,
                                                            const std::vector<std::string>& paths,
 ...
 * @throws std::invalid_argument If any path does not refer to a valid or Xformable prim.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API std::tuple<array::Array, array::Array> getXformWorldPoses(
    int64_t stageId, const std::vector<std::string>& paths);
 ...
 * length.
 */
ISAACSIM_FOUNDATION_USD_OPENUSD_API void setXformWorldPoses(int64_t stageId,
                                                            const std::vector<std::string>& paths,
