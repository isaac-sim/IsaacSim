...
import pytest
import warp as wp
from isaacsim.foundation.objects import Cube as Shape
...
def test_sizes(capsys: Any, stage: Any, populate: Any, values: Any) -> None:
    """Test sizes.
