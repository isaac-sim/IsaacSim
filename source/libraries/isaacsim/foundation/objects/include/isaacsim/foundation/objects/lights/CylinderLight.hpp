...
/**
 * @class CylinderLight
 * @brief Wrapper over one or more USD cylinder light prims.
 */
class ISAACSIM_FOUNDATION_OBJECTS_API CylinderLight : public Light
{
public:
    /**
    ...
    /**
     * @brief Get the radii (in scene units) of the selected cylinder light prims.
     * @param[in] indices Indices of prims to process. If omitted, all wrapped prims are processed.
    ...
    /**
     * @brief Set the lengths (heights, in scene units) of the selected cylinder light prims.
    ...
    /**
     * @brief Get the lengths (heights, in scene units) of the selected cylinder light prims.
     * @param[in] indices Indices of prims to process. If omitted, all wrapped prims are processed.
    ...
    /**
     * @brief Enable or disable treating the cylinder lights as line lights (zero-radius approximation).
     * @param[in] enabled Boolean flags (shape @c (N,)). Broadcast rules apply.
     * @param[in] indices Indices of prims to process. If omitted, all wrapped prims are processed.
     */
    void setEnabledTreatAsLines(const array::Array& enabled, const std::optional<array::Array>& indices = std::nullopt);

    /**
     * @brief Get the enabled state of the treat-as-line-light flag for the selected cylinder light prims.
     * @param[in] indices Indices of prims to process. If omitted, all wrapped prims are processed.
     * @return Boolean flags (shape @c (N,)).
     */
    array::Array getEnabledTreatAsLines(const std::optional<array::Array>& indices = std::nullopt);
};
