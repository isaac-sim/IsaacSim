...
/**
 * @class Capsule
 * @brief Wrapper over one or more USD capsule geometry prims.
 * @details
 * A capsule is a cylinder with hemispherical end-caps. The @p heights parameter refers to
 * the length of the cylindrical section only; the overall length includes the two hemisphere radii.
 */
class ISAACSIM_FOUNDATION_OBJECTS_API Capsule : public Shape
{
public:
    /**
     * @brief Construct a Capsule wrapper and optionally configure the initial geometry.
     * @param[in] paths                  Single path or list of paths to USD capsule prims.
     * @param[in] radii                  Initial hemisphere radii in scene units (shape @c (N,)). Optional.
     * @param[in] heights                Initial cylindrical section heights in scene units (shape @c (N,)). Optional.
     * @param[in] axes                   Alignment axis per capsule (@c "X", @c "Y", or @c "Z").
     ...
     */
    Capsule(const std::variant<std::string, std::vector<std::string>>& paths,
            // Capsule
    ...
    /**
     * @brief Set the hemisphere radii (in scene units) of the selected capsule prims.
    ...
    /**
     * @brief Get the hemisphere radii (in scene units) of the selected capsule prims.
     * @param[in] indices Indices of prims to process. If omitted, all wrapped prims are processed.
    ...
    /**
     * @brief Set the cylindrical section heights (in scene units) of the selected capsule prims.
    ...
    /**
     * @brief Get the cylindrical section heights (in scene units) of the selected capsule prims.
     * @param[in] indices Indices of prims to process. If omitted, all wrapped prims are processed.
    ...
    /**
     * @brief Set the alignment axes of the selected capsule prims.
    ...
    /**
     * @brief Get the alignment axes of the selected capsule prims.
     * @param[in] indices Indices of prims to process. If omitted, all wrapped prims are processed.
    ...
    /**
     * @brief Update the USD extent attribute of all wrapped capsule prims to match their current geometry.
     */
    void updateExtents();
};
