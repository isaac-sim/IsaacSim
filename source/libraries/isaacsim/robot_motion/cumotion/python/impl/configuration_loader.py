...
def load_cumotion_supported_robot(robot_name: str) -> CumotionRobot:
    ...
    Loads a pre-configured robot from the package's ``robot_configurations`` directory.
    This is a convenience function for commonly used robots bundled with the wheel.
    ...
    robot_directory = package_path / "robot_configurations" / robot_name
