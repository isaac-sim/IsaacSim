...
#include "ArticulationMetatype.hpp"
...
protected:
    ...
    py::object m_articulationIndicesWarp; ///< warp version of m_articulationIndices
    ...
    py::object m_articulationMask; ///< warp array that is used to mask only the selected articulations for newton
                                   ///< computation
